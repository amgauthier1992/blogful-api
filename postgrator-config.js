...
module.exports = {
  ...
  ? process.env.TEST_DB_URL //use test db url in testing environment. 
  : process.env.DB_URL, //grabbing the db url to run the migrations for when we deploy. we will initially run migrations concurrent with our 1st deployment.
}
